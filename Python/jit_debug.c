...
char *get_lir_opcode_name(const lir_op_t *op)
{
    ...
    case LIR_EQ_LL: return "LIR_EQ_NUM";
    case LIR_GE_LL: return "LIR_GE_NUM";
    case LIR_GT_LL: return "LIR_GT_NUM";
    case LIR_LE_LL: return "LIR_LE_NUM";
    case LIR_LT_LL: return "LIR_LT_NUM";
    case LIR_NE_LL: return "LIR_NE_NUM";
