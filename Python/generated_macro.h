...
// Do not edit!
        ...
        #define OP_LOAD_FAST__LOAD_FAST { \
            PyObject *_tmp_1; \
            PyObject *_tmp_2; \
            { \
                PyObject *value; \
        ...
        #define OP_LOAD_FAST__LOAD_CONST { \
            PyObject *_tmp_1; \
            PyObject *_tmp_2; \
            { \
                PyObject *value; \
        ...
        #define OP_STORE_FAST__LOAD_FAST { \
        ...
        #define OP_STORE_FAST__STORE_FAST { \
            PyObject *_tmp_1 = stack_pointer[-1]; \
        ...
        #define OP_LOAD_CONST__LOAD_FAST { \
            PyObject *_tmp_1; \
            PyObject *_tmp_2; \
            { \
                PyObject *value; \
        ...
        #define OP_INSTRUMENTED_END_FOR { \
            PyObject *value = stack_pointer[-1]; \
        ...
        #define OP_INSTRUMENTED_END_SEND { \
            PyObject *value = stack_pointer[-1]; \
            PyObject *receiver = stack_pointer[-2]; \
        ...
        #define OP_BINARY_OP_MULTIPLY_INT { \
        ...
        #define OP_BINARY_OP_MULTIPLY_FLOAT { \
            PyObject *right = stack_pointer[-1]; \
            PyObject *left = stack_pointer[-2]; \
            PyObject *prod; \
        ...
        #define OP_BINARY_OP_SUBTRACT_INT { \
            PyObject *right = stack_pointer[-1]; \
            PyObject *left = stack_pointer[-2]; \
            PyObject *sub; \
            DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP); \
        ...
        #define OP_BINARY_OP_SUBTRACT_FLOAT { \
            PyObject *right = stack_pointer[-1]; \
            PyObject *left = stack_pointer[-2]; \
            PyObject *sub; \
            DEOPT_IF(!PyFloat_CheckExact(left), BINARY_OP); \
        ...
        #define OP_BINARY_OP_ADD_UNICODE { \
            PyObject *right = stack_pointer[-1]; \
            PyObject *left = stack_pointer[-2]; \
            PyObject *res; \
        ...
        #define OP_BINARY_OP_INPLACE_ADD_UNICODE { \
            PyObject *right = stack_pointer[-1]; \
            PyObject *left = stack_pointer[-2]; \
            DEOPT_IF(!PyUnicode_CheckExact(left), BINARY_OP); \
            DEOPT_IF(Py_TYPE(right) != Py_TYPE(left), BINARY_OP); \
        ...
        #define OP_BINARY_SUBSCR_LIST_INT { \
            PyObject *sub = stack_pointer[-1]; \
 ...
 \
        ...
        #define OP_BINARY_SUBSCR_TUPLE_INT { \
            PyObject *sub = stack_pointer[-1]; \
 ...
 \
        ...
        #define OP_BINARY_SUBSCR_GETITEM { \
            PyObject *sub = stack_pointer[-1]; \
            PyObject *container = stack_pointer[-2]; \
        ...
        #define OP_STORE_SUBSCR_LIST_INT { \
            PyObject *sub = stack_pointer[-1]; \
            PyObject *list = stack_pointer[-2]; \
 ...
 \
        ...
        #define OP_INSTRUMENTED_RETURN_VALUE { \
            PyObject *retval = stack_pointer[-1]; \
        ...
        #define OP_INSTRUMENTED_RETURN_CONST { \
            PyObject *retval = GETITEM(frame->f_code->co_consts, oparg); \
            int err = _Py_call_instrumentation_arg( \
                    tstate, PY_MONITORING_EVENT_PY_RETURN, \
                    frame, next_instr-1, retval); \
 ...
 \
        ...
        #define OP_INSTRUMENTED_YIELD_VALUE { \
            PyObject *retval = stack_pointer[-1]; \
            assert(frame != &entry_frame); \
        ...
        #define OP_LOAD_ASSERTION_ERROR { \
            PyObject *value; \
        ...
        #define OP_UNPACK_SEQUENCE_TWO_TUPLE { \
            PyObject *seq = stack_pointer[-1]; \
        ...
        #define OP_UNPACK_SEQUENCE_TUPLE { \
            PyObject *seq = stack_pointer[-1]; \
            PyObject **values = stack_pointer - (1); \
            DEOPT_IF(!PyTuple_CheckExact(seq), UNPACK_SEQUENCE); \
        ...
        #define OP_UNPACK_SEQUENCE_LIST { \
            PyObject *seq = stack_pointer[-1]; \
            PyObject **values = stack_pointer - (1); \
        ...
        #define OP_LOAD_FROM_DICT_OR_GLOBALS { \
 ...
 \
        ...
        #define OP_LOAD_FROM_DICT_OR_DEREF { \
 ...
 \
        ...
        #define OP_INSTRUMENTED_LOAD_SUPER_ATTR { \
 ...
 \
        ...
        #define OP_LOAD_SUPER_ATTR_ATTR { \
            PyObject *self = stack_pointer[-1]; \
            PyObject *class = stack_pointer[-2]; \
            PyObject *global_super = stack_pointer[-3]; \
            PyObject *res2 = NULL; \
        ...
        #define OP_LOAD_SUPER_ATTR_METHOD { \
            PyObject *self = stack_pointer[-1]; \
            PyObject *class = stack_pointer[-2]; \
            PyObject *global_super = stack_pointer[-3]; \
            PyObject *res2; \
 ...
 \
        ...
        #define OP_LOAD_ATTR_INSTANCE_VALUE { \
            PyObject *owner = stack_pointer[-1]; \
            PyObject *res2 = NULL; \
            PyObject *res; \
 ...
 \
        ...
        #define OP_LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN { \
            PyObject *owner = stack_pointer[-1]; \
            uint32_t type_version = read_u32(&next_instr[1].cache); \
            uint32_t func_version = read_u32(&next_instr[3].cache); \
 ...
 \
        ...
        #define OP_STORE_ATTR_INSTANCE_VALUE { \
            PyObject *owner = stack_pointer[-1]; \
        ...
        #define OP_STORE_ATTR_WITH_HINT { \
            PyObject *owner = stack_pointer[-1]; \
            PyObject *value = stack_pointer[-2]; \
            uint32_t type_version = read_u32(&next_instr[1].cache); \
 ...
 \
        ...
        #define OP_JUMP_FORWARD { \
            JUMPBY(oparg); \
            DISPATCH(); \
        }

        #define OP_JUMP_BACKWARD { \
        ...
        #define OP_POP_JUMP_IF_NOT_NONE { \
            PyObject *value = stack_pointer[-1]; \
            if (!Py_IsNone(value)) { \
                Py_DECREF(value); \
                JUMPBY(oparg); \
        ...
        #define OP_JUMP_BACKWARD_NO_INTERRUPT { \
        ...
        #define OP_INSTRUMENTED_FOR_ITER { \
 ...
 \
        ...
        #define OP_LOAD_ATTR_METHOD_WITH_VALUES { \
            PyObject *self = stack_pointer[-1]; \
            PyObject *res2 = NULL; \
            PyObject *res; \
            uint32_t type_version = read_u32(&next_instr[1].cache); \
        ...
        #define OP_LOAD_ATTR_METHOD_NO_DICT { \
            PyObject *self = stack_pointer[-1]; \
            PyObject *res2 = NULL; \
            PyObject *res; \
            uint32_t type_version = read_u32(&next_instr[1].cache); \
        ...
        #define OP_LOAD_ATTR_METHOD_LAZY_DICT { \
            PyObject *self = stack_pointer[-1]; \
            PyObject *res2 = NULL; \
            PyObject *res; \
            uint32_t type_version = read_u32(&next_instr[1].cache); \
        ...
        #define OP_CALL_BOUND_METHOD_EXACT_ARGS { \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
        ...
        #define OP_CALL_PY_WITH_DEFAULTS { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            uint32_t func_version = read_u32(&next_instr[1].cache); \
        ...
        #define OP_CALL_NO_KW_BUILTIN_O { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
 ...
 \
        ...
        #define OP_CALL_NO_KW_BUILTIN_FAST { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
 ...
 \
        ...
        #define OP_CALL_BUILTIN_FAST_WITH_KEYWORDS { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
 ...
 \
        ...
        #define OP_CALL_NO_KW_ISINSTANCE { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *callable = stack_pointer[-(1 + oparg)]; \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
 ...
 \
        ...
        #define OP_CALL_NO_KW_LIST_APPEND { \
            PyObject **args = (stack_pointer - oparg); \
        ...
        #define OP_CALL_NO_KW_METHOD_DESCRIPTOR_O { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
            assert(kwnames == NULL); \
        ...
        #define OP_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
            int is_meth = method != NULL; \
 ...
 \
        ...
        #define OP_CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
            assert(kwnames == NULL); \
        ...
        #define OP_CALL_NO_KW_METHOD_DESCRIPTOR_FAST { \
            PyObject **args = (stack_pointer - oparg); \
            PyObject *method = stack_pointer[-(2 + oparg)]; \
            PyObject *res; \
            assert(kwnames == NULL); \
        ...
        #define OP_INSTRUMENTED_CALL_FUNCTION_EX { \
            GO_TO_INSTRUCTION(CALL_FUNCTION_EX); \
        }

        #define OP_CALL_FUNCTION_EX { \
 ...
 \
        ...
        #define OP_INSTRUMENTED_INSTRUCTION { \
        ...
        #define OP_INSTRUMENTED_JUMP_FORWARD { \
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP); \
            DISPATCH(); \
        }

        #define OP_INSTRUMENTED_JUMP_BACKWARD { \
            INSTRUMENTED_JUMP(next_instr-1, next_instr-oparg, PY_MONITORING_EVENT_JUMP); \
            CHECK_EVAL_BREAKER(); \
            DISPATCH(); \
        }

        #define OP_INSTRUMENTED_POP_JUMP_IF_TRUE { \
            PyObject *cond = POP(); \
            int err = PyObject_IsTrue(cond); \
            Py_DECREF(cond); \
            if (err < 0) goto error; \
        ...
        #define OP_INSTRUMENTED_POP_JUMP_IF_FALSE { \
            PyObject *cond = POP(); \
            int err = PyObject_IsTrue(cond); \
            Py_DECREF(cond); \
            if (err < 0) goto error; \
        ...
        #define OP_INSTRUMENTED_POP_JUMP_IF_NONE { \
            PyObject *value = POP(); \
            _Py_CODEUNIT *here = next_instr-1; \
            int offset; \
            if (Py_IsNone(value)) { \
        ...
        #define OP_INSTRUMENTED_POP_JUMP_IF_NOT_NONE { \
            PyObject *value = POP(); \
            _Py_CODEUNIT *here = next_instr-1; \
            int offset; \
            if (Py_IsNone(value)) { \
